...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    if (errorDescription) {
      console.error('[Google Callback] Error Description:', errorDescription);
    ...
    if (error) {
      console.error('[Google Callback] Exchange Error:', error.message);
      return NextResponse.redirect(
    ...
    console.error('[Google Callback] Runtime Error:', err);
    return NextResponse.redirect(
