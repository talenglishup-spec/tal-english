...
export const GUIDE_STEPS: GuideStep[] = [
  {
    ...
    //     내 발음 vs 모범 답안 비교
    //  3) 기록 탭 도장판 — 통과한 표현이 채워지고 레벨이 열린다
    //  4) 매일 훈련하고 성장 — 레벨·연속 스트릭, 마이 탭에서 성장 기록 확인
    // XP·선수 카드는 체험단 동안 화면에서 내렸으므로 안내에서도 뺀다.
    caption: 'AI 코치가 ① 쇼츠 쉐도잉으로 귀 트기 ② Speak 버튼 발화 훈련(단어별 채점·모범답안 비교) ③ 기록 탭 도장판 채우기 ④ 매일 성장(레벨·스트릭)까지, 앱 사용법 전체를 한 영상으로 안내합니다.',
